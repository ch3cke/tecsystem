...
public class putSchedule extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(flag!=null){
            ...
            schedule.put("Sid","121212121212121121212");
            File myfile = new File(ppath+schedule.get("Sid"));
            if(!myfile.exists()){
                myfile.mkdir();
            }
            ...
            List<String> paths = upload.uploadFile(request,ppath+schedule.get("Sid"), 1024 * 30, 1024 * 30, null);
            if(paths.isEmpty()){
