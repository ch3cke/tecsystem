...
<div id="frame" style="height: 268px;margin-top;-137px;">
    <div class="reset">
        <div class="holder">
            <div class="with-line">找回密码</div>
            <form class="reset-form" action="#" onclick="return change()">
                <input type="text" name="code" class="clear" placeholder="输入验证码">
                <input type="password" name="password" class="clear" placeholder="输入新密码">
                <a class="button1" >重置</a>
            </form>
        </div>
    </div>
</div>
