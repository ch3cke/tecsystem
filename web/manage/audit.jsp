...
<tbody>
		  <c:forEach items="${sapplicants}" var="sapplicants">
	   <tr>
	  
	    
	  <td>${sapplicants.getAid() }</td>
	  <td>${sapplicants.getName }</td>
	  <td>${sapplicants.getDname}</td>
	  <td>${sapplicants.getAreason1 }</td>
	  <td>${sapplicants.getAreason2}</td>
	  <td>${sapplicants.getAreason3 }</td>
